...
var FuseautomaticComponent = (function () {
    ...
    FuseautomaticComponent.prototype.init = function () {
        ...
        this.mainServ.APIServ.get("billing/getSellerCash?type=automatic").subscribe(function (data) {
            if (_this.mainServ.APIServ.getErrorCode() == 0) {
                _this.cash = data['SUM'];
            }
        });
...
var FusemanualComponent = (function () {
    ...
    FusemanualComponent.prototype.initData = function (withFilter) {
        ...
        this.mainServ.APIServ.get("billing/getSellerCash?type=manual").subscribe(function (data) {
            if (_this.mainServ.APIServ.getErrorCode() == 0) {
                _this.cash = data['SUM'];
            }
        });
    ...
    FusemanualComponent.prototype.activeUser = function (user) {
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                _this.mainServ.APIServ.put("pendingClient/activePenddingClient", { "id": user.id }).subscribe(function (data) {
                    if (_this.mainServ.APIServ.getErrorCode() == 0) {
                        _this.initData(true);
                    }
                });
